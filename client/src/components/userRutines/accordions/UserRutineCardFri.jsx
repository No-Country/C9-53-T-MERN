...
const UserRutineCardFri = () => {

  const {rutineFri} = useContext(EjsByDayContext)
  ...
  <div>
    ...
    className={style.button}>
      ...
      {isOpen &&(
        ...
        className={style.UserRutineCard}>{rutineFri.map((rutineItem) => (
...
export default UserRutineCardFri