...
const UserRutineCardSat = () => {

  const {rutineSat} = useContext(EjsByDayContext)
  ...
  <div>
    ...
    className={style.button}>
      ...
      {isOpen &&(
        ...
        className={style.UserRutineCard}>{rutineSat.map((rutineItem) => (
...
export default UserRutineCardSat