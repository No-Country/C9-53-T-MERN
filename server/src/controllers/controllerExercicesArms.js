const ServiceExercisesArms = require('../services/serviceExercisesArms');

const service = new ServiceExercisesArms();

const controllerExercisesArms = {
...
module.exports = controllerExercisesArms;
